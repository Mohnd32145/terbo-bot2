...
| ${chalk.blueBright('________')} 
|${lineM}\n${chalk.bold.magentaBright('shawarma')}`)
if (!/^[1-2]$/.test(opcion)) {
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['shawarma', 'Edge', '20.0.04'] : methodCodeQR ? ['shawarma', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
number = number.replace('+20', '+20'); // Cambiar +521 a +52
